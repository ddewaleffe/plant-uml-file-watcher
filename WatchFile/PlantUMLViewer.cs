    ...
    internal partial class PlantUMLViewer : Form
    {
        ...
        internal bool LoadFile(string fullPathToFile)
        {
            ...
            try
            {
                ...
                string tmpFile = _tempFilePath + _tempFileName;
                try
                {
                ...
                {
                    textBox2.Text += $"{tmpFile} exists but could not be deleted. {e.Message}" + Environment.NewLine;
                }
                ...
                textBox2.Text += startInfo.Arguments + Environment.NewLine;
                ...
                using (var fs = new System.IO.FileStream(tmpFile, FileMode.Open, FileAccess.Read))
                {
                    pictureBox.Image = System.Drawing.Image.FromStream(fs);
                }
                //pictureBox.Load(tmpFile);
